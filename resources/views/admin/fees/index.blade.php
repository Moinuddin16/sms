            ...
            <div class="row mb-6">
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4">
                    ...
                    <div class="card">
                        <div class="card-body">
                            @if(isset($editData))
                                <form action="{{ route('fees.update', [$editData->id]) }}" method="PUT" enctype="multipart/form-data">
                            @else
                                ...
                                <tbody>
                                    @foreach ($fees as $fee)
                                        <tr>
                                            <td>{{ $fee->name }}</td>
                                            <td width="30%">
                                                <input type="checkbox" onchange="changeFeesStatus({{$fee->id}},{{$fee->active_status}})"  @if($fee->active_status == 1) checked @endif >
                                            </td>
                                            <td width="30%" class="text-center">
                                                <a href="{{ route('fees.edit', $fee->id) }}" class="btn edit-btn btn-primary">Edit</a>
                                            </td>
                                    @endforeach
                            </table>
